...
This repository is public, documented, tested in CI, and ready to share.
...
The profile pin could not be automated from this environment because the available GitHub API schema exposes issue/comment pinning, but not profile repository pinning.
